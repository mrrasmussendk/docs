...
Yes. You can pull docs from another repository in a GitHub Action, commit the synced files in this docs repository, and let that push trigger a new Mintlify deployment.
